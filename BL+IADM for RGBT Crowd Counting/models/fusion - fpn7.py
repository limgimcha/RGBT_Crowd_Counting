...
class FusionModel(nn.Module):
    def __init__(self, block, num_blocks):
        ...
        self.conv2 = nn.Conv2d(256, 3, kernel_size=1, stride=1, padding=0, bias=False)
        ...
        self.block3 = Block([c3, c3, c3, 'M'], in_channels=c2)
        self.block4 = Block([c4, c4, c4, 'M'], in_channels=c3)
        self.block5 = Block([c4, c4, c4,], in_channels=c4)
