...
class SASNet(nn.Module):
    ...
    def forward(self, RGBT):
        ...
        confidence_map = F.avg_pool2d(confidence_map, kernel_size=8, stride=8, padding=0)
        ...
        density_map = F.avg_pool2d(density_map, kernel_size=8, stride=8, padding=0)
        # soft selection
