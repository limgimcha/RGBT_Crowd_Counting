...
class FusionModel(nn.Module):
    def __init__(self, block, num_blocks):
        ...
        self.block1 = Block([c1, c1], in_channels=256, first_block=True)
        self.block2 = Block([c2, c2], in_channels=c1)
        self.block3 = Block([c3, c3, c3, c3], in_channels=c2)
