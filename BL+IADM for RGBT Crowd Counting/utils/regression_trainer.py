...
class RegTrainer(Trainer):
    ...
    # def dynamic_lrate(self, lr):
    #     k = 0.1
    #     t = time.time()
    #     lrate = lr * math.exp(-k*t)
    #     return lrate

    def train(self):
        """training process"""
        args = self.args
        # scheduler1 = torch.optim.lr_scheduler.CosineAnnealingLR(self.optimizer, T_max=10, eta_min=0)
        # scheduler2 = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(self.optimizer, T_0=10, T_mult=1, eta_min=0.001, last_epoch=-1)
